...
setwd("C:/Users/aksha/Videos") # Set the path where file located

cpi_data <- read.xlsx("CPI.xlsx",1)

### Exploratory Data Analysis ###

dim(cpi_data) # To show the dimensions of data
...
cpi_neural_forecast1 = as.numeric(t(as.data.frame(cpi_neural_forecast))[,1:2])

cpi_neural_forecast2 = na.omit(cpi_neural_forecast1)
